...
use crate::{
    Board, BoardCompletedEvent, BoardExplosionEvent, Bomb, BombNeighbor, Coordinates, Uncover,
};
use bevy::log;
use bevy::prelude::*;
...
pub fn uncover_tiles(
    ...
    mut bomb_explosion_event_wr: EventWriter<BoardExplosionEvent>,
) {
    ...
    for (entity, parent) in children.iter() {
        ...
        if bomb.is_some() {
            log::info!("Boom!");
            bomb_explosion_event_wr.send(BoardExplosionEvent);
        }
